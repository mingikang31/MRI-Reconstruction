"""
Reconstruction Attention U-Net Model with Coil Sensitivity Estimation Module. 
"""
import torch 
import torch.nn as nn 
import torch.nn.functional as F 

from models.attention_unet import NormAttentionUnet
...
class ReconAttentionUnet(nn.Module):
    """Reconstruction Attention U-Net model with coil sensitivity estimation for MRI reconstruction."""
...
class ReconAttentionUnetBlock(nn.Module):
    """Single block for ReconAttentionUnetBlock model."""
    def __init__(self, model):
        super(ReconAttentionUnetBlock, self).__init__()
        self.model = model
...
class SensitivityModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.norm_attention_unet = NormAttentionUnet(
            channels=channels,
